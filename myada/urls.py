...
from myada.EditResultView import EditResultView

from . import hod_views, staff_excel_views, student_excel_views, staff_views, student_views, staff_upload, views, student_append
...
urlpatterns = [
    ...
    path("course/delete/<int:department_id>",
         hod_views.delete_course, name='delete_course'),

    path("subject/delete/<int:course_id>",
    ...
    path("course/edit/<int:department_id>",
    ...
    path('staff/view/result/', staff_views.staff_view_result,
         name='staff_view_result'),
    path('generate_spreadsheets/', staff_excel_views.create_excel_sheets,
         name='generate_spreadsheets'),
    path('view_spreadsheet/', staff_excel_views.view_spreadsheet,
         name='view_spreadsheet'),
    path('upload_excel/', staff_upload.upload_excel,
         name='upload_excel'),
    ...
    path('create_spreadsheets/', student_excel_views.create_excel_sheets,
         name='create_spreadsheets'),
    path('open_spreadsheet/', student_excel_views.view_spreadsheet,
